...
<!-- start data buku -->
    ...
    <!-- end pagination -->
        ...
        <table class="table table-light border-primary">
         ...
         <tr>
          <td>Stok buku yang tersedia: <?= intval($data["stok_buku"] ?? '') ?></td>
         </tr>
         <tr>
          <td class="text-center">
          
        <a href="" class="btn btn-primary" onclick="ajukanPinjam(event, 'pinjam_buku.php?id_buku=<?=htmlspecialchars($data['id_buku'] ?? '')?>')">Ajukan peminjaman buku</a>
        ...
        <?php
            endwhile;
              ...
              echo "<script>alert('Buku yang anda cari tidak ada'); window.location.href = 'dashboard.php';</script>";
             endif; ?>
      </section>
      <!-- end data buku -->
