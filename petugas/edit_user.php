...
<form class="pt-5 mt-5" action="" method="post">
        <div class="centered">
            ...
            <h2 class="text-bold text-center">Halaman edit akun Book Lovers</h2>
    
            <div class="mb-3 mt-5">
          <label for="username" class="form-label" >Username</label>
          <input type="text" class="form-control" id="username" name="username" value="<?= htmlspecialchars($info_user['username']) ?>" required>
        </div>
      <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label" >Email address</label>
          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?= htmlspecialchars($info_user['email']) ?>" required>
          <div id="emailHelp" class="form-text">Kami tidak akan membagikan email anda ke siapapun</div>
        </div>
        <div class="mb-3">
          <label for="no_hp" class="form-label" >No. Hp</label>
          <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?= htmlspecialchars($info_user['no_hp']) ?>" required>
        </div>
