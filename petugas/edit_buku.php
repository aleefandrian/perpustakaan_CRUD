...
<!-- start tambah buku -->
<form class="pt-5 mt-5" action="?id_buku=<?= $id_buku ?>" method="post" enctype="multipart/form-data">
        <div class="centered">
        
            <div class="container">
            <h2 class="text-bold text-center">Halaman edit buku</h2>
               
  <div class="mb-3">
    <label for="judul" class="form-label">Judul buku</label>
    <input type="text" class="form-control" name="judul" id="judul" value="<?= htmlspecialchars($info_buku['judul']) ?>" placeholder="Judul buku" required>
  </div>
  <div class="mb-3">
    <label for="pengarang" class="form-label">Pengarang</label>
    <input type="text" class="form-control" name="pengarang" id="pengarang" value="<?= htmlspecialchars($info_buku['pengarang']) ?>" placeholder="Pengarang" required>
  </div>
  <div class="mb-3">
    <label for="penerbit" class="form-label">Penerbit</label>
    <input type="text" class="form-control" name="penerbit" id="penerbit" value="<?= htmlspecialchars($info_buku['penerbit']) ?>" placeholder="Penerbit" required>
  </div>
  <div class="mb-3">
    <label for="genre" class="form-label">Genre</label>
    <input type="text" class="form-control" name="genre" id="genre" value="<?= htmlspecialchars($info_buku['genre']) ?>" placeholder="Genre" required>
  </div>
  <div class="form mb-3">
  <label for="sinopsis" class="form-label">Sinopsis</label>
  <textarea class="form-control" placeholder="Sinopsis" name="sinopsis" id="sinopsis" style="height: 200px" required><?= htmlspecialchars($info_buku['sinopsis']) ?></textarea>
</div>
<div class="form mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="file" class="form-control" name="gambar" id="gambar" placeholder="Upload Gambar">
  </div>

  <button type="submit" class="btn btn-primary" name="editBuku" onclick="edit()">Submit</button>
</div>
    </div>
    </form>
    <!-- end tambah buku -->
